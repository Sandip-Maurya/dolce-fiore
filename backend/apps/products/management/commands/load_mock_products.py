...
MOCK_PRODUCTS = [
    ...
    },
    {
        ...
        'description': 'Indulge guilt-free with our curated selection of sugar-free desserts. Featuring air-fried cookies, natural sweetener-based cakes, and artisanal treats. All ingredients are organic and locally sourced. Each item is handcrafted with care, ensuring premium quality and taste. Packaged in reusable glass jars and cloth bags.',
        'price': 1899,
        'currency': 'INR',
        'category': 'SWEET',
        'images': [
    ...
    },
    {
        ...
        'description': 'A premium collection of handcrafted cookies made with organic flour, natural sweeteners, and traditional recipes. Each cookie is baked fresh and features unique flavors like almond cardamom, coconut jaggery, and chocolate chip with dates. Presented in a beautiful wooden box with eco-friendly packaging.',
        'price': 1299,
        'currency': 'INR',
        'category': 'COOKIE',
        'images': [
    ...
    },
    {
        ...
        'description': 'A thoughtfully curated hamper of air-fried savories and organic snacks. Features baked namkeen, roasted nuts, and traditional Indian snacks made with minimal oil and natural ingredients. All items are handcrafted by local artisans and packaged in reusable containers. Perfect for health-conscious individuals who love flavor.',
        'price': 1599,
        'currency': 'INR',
        'category': 'HAMPER',
        'images': [
    ...
    },
    {
        ...
        'description': 'Our signature gift hamper featuring a premium selection of organic sweets, sugar-free chocolates, artisanal cookies, and air-fried savories. All items are handcrafted with care and packaged in sustainable materials including kraft paper, jute bags, and reusable glass containers. A perfect gift that celebrates conscious living and premium quality.',
        'price': 3499,
        'currency': 'INR',
        'category': 'HAMPER',
        'images': [
    ...
    },
    {
        ...
        'description': 'A collection of traditional Indian sweets reimagined with organic ingredients and natural sweeteners. Features besan ladoo, coconut barfi, and date rolls, all made by skilled local artisans. Each sweet is handcrafted and wrapped in eco-friendly packaging. A perfect blend of tradition and conscious living.',
        'price': 999,
        'currency': 'INR',
        'category': 'SWEET',
        'images': [
    ...
    },
    {
        ...
        'description': 'A premium selection of air-fried and baked snacks made with organic ingredients. Features multigrain chips, spiced nuts, and traditional namkeen varieties. All snacks are prepared with minimal oil and natural seasonings. Packaged in reusable containers with eco-friendly materials.',
        'price': 1199,
        'currency': 'INR',
        'category': 'SNACK',
        'images': [
...
class Command(BaseCommand):
    help = 'Load mock products into the database'
    ...
    def handle(self, *args, **options):
        ...
        for product_data in MOCK_PRODUCTS:
            ...
            if Product.objects.filter(slug=slug).exists():
                self.stdout.write(
                    self.style.WARNING(f'Product "{product_data["name"]}" already exists. Skipping.')
                )
                skipped_count += 1
                continue
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f'\nSuccessfully loaded {created_count} product(s). '
                f'Skipped {skipped_count} existing product(s).'
            )
        )
